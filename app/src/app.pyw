...
class App(CTk):
    def __init__(self):
        ...
        self.c.registerItem('dp_format', '$NAME [datapack] v$VERSION')
        self.c.registerItem('rp_format', '$NAME [resources] v$VERSION')
        self.c.registerItem('zip_format', '$NAME UNZIP v$VERISON')
