...
# Register Datapack
data modify storage legopitstop:registered_datapacks datapacks merge value {record:{namespace:"record",pack_version:"1.0.0",mc_version:"1.18",multiplayer_tested:"no",has_config:"no",pack:{update_url: "URL",title:"Record API",description:"Add an unlimited amount of discs to your world!",uuid:"6f085f37-b5d3-4c40-bf4d-90496f9992c1"}}}
