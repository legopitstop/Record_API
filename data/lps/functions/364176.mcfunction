...
# 1.19.1 3106 - 3117
# 1.19   3080 - 3105
data modify storage lps:datapacks pack set value {id: 364176, name: 'Record API', description:'Add an unlimited amount of discs to your world!', version: "1.1.0", minDataVersion: 3320, updateChecker: '{"text": "[Update Checker]", "clickEvent": {"action": "open_url", "value": "https://legopitstop.github.io/Update_Checker/update-checker.html?updateJSONURL=https%3A%2F%2Fraw.githubusercontent.com%2Flegopitstop%2FRecord_API%2Fmain%2Fupdate.json&mcversion=1.19.4&modversion=1.1.0"}}'}
