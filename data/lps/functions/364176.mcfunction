...
# 1.20   3442 - 3463
# 1.20.2 3567 - 
data modify storage lps:datapacks pack set value {id: 364176, name: 'Record API', description:'Add an unlimited amount of discs to your world!', version: "1.2.0", minDataVersion: 3569, updateChecker: '{"text": "[Update Checker]", "clickEvent": {"action": "open_url", "value": "https://legopitstop.github.io/Update_Checker/update-checker.html?updateJSONURL=https%3A%2F%2Fraw.githubusercontent.com%2Flegopitstop%2FRecord_API%2Fmain%2Fupdate.json&mcversion=1.20.2&modversion=1.2.0"}}'}
